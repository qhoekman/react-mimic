...
type Sizing = keyof (typeof MyTheme.width);
interface IProps {
	width: Sizing;
	height: Sizing;
}

const Container = Styled<'svg', IProps>('svg')(({ theme, width, height }) => ({
	width,
	height,
	fill: `url(#logo) ${theme.colors.primary}`
}));

export const SvgLogo: React.FC<IProps> = ({ width, height }) => {
	return (
